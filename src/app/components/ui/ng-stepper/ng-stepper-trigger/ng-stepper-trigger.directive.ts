...
export class NgStepperTriggerDirective {
  ...
  protected _computedClass = computed(() =>
    hlm(
      'data-[selected=true]:w-8 data-[selected=true]:h-8 data-[selected=false]:bg-muted-foreground data-[selected=false]:w-3 data-[selected=false]:h-3 data-[selected=false]:m-2.5 data-[selected=false]:text-transparent bg-[#A8F48E] rounded-full flex items-center justify-center font-bold text-background data-[state=active]:shadow-[0_0_0_3px_#1E1E1E,0_0_0_4px_#A8F48E]',
      this.userClass()
    )
  );
