...
export const inputVariants = cva(
  'flex rounded-xl border font-normal border-input bg-card text-sm text-foreground file:border-0 file:text-foreground file:bg-transparent file:text-sm file:font-medium placeholder:text-foreground focus-visible:outline-none focus-visible:border-primary disabled:cursor-not-allowed disabled:opacity-50',
  {
    variants: {
      size: {
        default: 'h-14 p-5',
