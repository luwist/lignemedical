...
export const hlmMenuItemVariants = cva(
  'group w-full h-11 relative flex cursor-pointer select-none px-6 items-center text-sm outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:bg-accent focus-visible:text-accent-foreground disabled:pointer-events-none disabled:opacity-50',
  {
